...
// 5. Get the 0-5 navigability score per day (for the accordion header) — calculé directement
// à partir des lignes groupées de la synthèse, pour rester cohérent avec ce qui y est affiché
